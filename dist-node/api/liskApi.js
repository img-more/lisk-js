...
LiskAPI.prototype.getAccount = function getAccount(address, callback) {
  return this.sendRequest(GET, 'accounts', { address: address }, function (result) {
...
LiskAPI.prototype.listActiveDelegates = function listActiveDelegates(limit, callback) {
  this.sendRequest(GET, 'delegates/', { limit: limit }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.listStandbyDelegates = function listStandbyDelegates(limit, callback) {
  ...
  this.sendRequest(GET, 'delegates/', { limit: limit, orderBy: 'rate:asc', offset: standByOffset }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.searchDelegateByUsername = function searchDelegateByUsername(username, callback) {
  this.sendRequest(GET, 'delegates/search/', { q: username }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.listBlocks = function listBlocks(amount, callback) {
  this.sendRequest(GET, 'blocks', { limit: amount }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.listForgedBlocks = function listForgedBlocks(publicKey, callback) {
  this.sendRequest(GET, 'blocks', { generatorPublicKey: publicKey }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.getBlock = function getBlock(block, callback) {
  this.sendRequest(GET, 'blocks', { height: block }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.listTransactions = function listTransactions(address) {
  ...
  this.sendRequest(GET, 'transactions', { senderId: address, recipientId: address, limit: limit, offset: offset, orderBy: 'timestamp:desc' }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.getTransaction = function getTransaction(transactionId, callback) {
  this.sendRequest(GET, 'transactions/get', { id: transactionId }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.listVotes = function listVotes(address, callback) {
  this.sendRequest(GET, 'accounts/delegates', { address: address }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.listVoters = function listVoters(publicKey, callback) {
  this.sendRequest(GET, 'delegates/voters', { publicKey: publicKey }, function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.sendLSK = function sendLSK(recipient, amount, secret, secondSecret, callback) {
  this.sendRequest(POST, 'transactions', { recipientId: recipient, amount: amount, secret: secret, secondSecret: secondSecret }, function (response) {
...
LiskAPI.prototype.listMultisignatureTransactions = function listMultisignatureTransactions(callback) {
  this.sendRequest(GET, 'transactions/multisignatures', function (result) {
    return callback(result);
  });
};
...
LiskAPI.prototype.getMultisignatureTransaction = function getMultisignatureTransaction(transactionId, callback) {
  this.sendRequest(GET, 'transactions/multisignatures/get', { id: transactionId }, function (result) {
    return callback(result);
  });
};
